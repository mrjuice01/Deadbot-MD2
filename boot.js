...
async function startKUMUTHU() {
    ...
    KUMUTHU.sendMessage(callerId, { text: `⚠️BayMax Automatic Block System!\n⚠️Don't Call Bot!\n⚠️Please Ask Or Contact The Owner Mr Juice To Unblock You!`}, { quoted : xeonfek })
    await sleep(8000)
